...
export const options = {
  symptoms: [
    ...
    { label: 'Shortness of breath/difficulty breathing', value: 'difficulty_breathing' },
    { label: 'Tiredness/Fatigue', value: 'tiredness' },
  ...
  symptoms_duration: [
    { label: 'A day ago', value: 'a_day_ago' },
    ...
    { label: 'A week ago', value: 'a_week_ago' },
    { label: '2 weeks ago', value: '2_weeks_ago' },
    { label: 'A month ago', value: 'a_month_ago' },
  ],
  other_health_conditions: [
    {label: 'Hypertension', value: 'hypertension'},
    {label: 'Diabetes', value: 'diabetes'},
    {label: ' Heart related disease', value: 'heart_related_disease'},
    {label: ' Kidney related disease', value: 'kidney_related_disease'},
    {label: ' Liver related disease', value: 'liver_related_disease'},
...
export const parseFormPayload = (
  ...
  Object.keys(payload).forEach(key => {
    ...
    if (selectables.includes(key)) {
      if (isObject(item) && isSelectInput(item)){
        payload[key] = item.value;
      } else if (isArray(item)) {
        payload[key] = item.filter(item => isSelectInput(item)).map(item => item.value);
      }
    }
    if (
      typeof item === 'object' &&
